...
public class Books
{
	...
	private static void addToDatabase()
	{
		try
		{
			...
			st.executeUpdate("INSERT INTO books (title, author, description) VALUES ('The End of Faith', 'Sam Harris', 'Delivers a startling analysis of the clash of faith and reason in the modern world.');");
